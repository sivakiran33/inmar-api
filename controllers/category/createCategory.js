...
module.exports = async(req, res) => {
    ...
    try{
        ...
        newCategory.location_id = locationId;
        newCategory.department_id = departmentId;
        
        let dataObj = await categoryDao.insertCategory(newCategory);
        ...
        console.log(error);
        apiResponse.fail('Failed to create category', res);
        return;
    }
